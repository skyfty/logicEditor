...
$dbname = "KlondikeEditor";
  ...
  $movesMax = $_POST['movesMax'];
          ...
          case 'levelDifficulty':
                  $sql = "UPDATE $children SET difficulty='$difficulty',grade='$grade',gold='$gold',experience='$experience',diamond='$diamond',movesMax='$movesMax',movesMin='$movesMin' WHERE id = '$id'";
          break;
	        default:
	            echo '修改失败';
	            break;
